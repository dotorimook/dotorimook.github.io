...
const index = require('./index-7d6eb03a.js');
...
const DeckdeckgoHighlightCode = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: hostClass, onClick: () => this.edit() }, this.renderCarbon(), this.renderUbuntu(), index.h("div", { class: "deckgo-highlight-code-container" }, index.h("code", { contentEditable: this.editable, onBlur: async () => await this.applyCode(), onInput: () => this.inputCode(), onKeyDown: ($event) => this.catchTab($event), ref: (el) => (this.refCode = el) }), index.h("slot", { name: "code" }))));
  }
  renderCarbon() {
    if (this.terminal !== deckdeckgoHighlightCodeCarbonTheme.DeckdeckgoHighlightCodeTerminal.CARBON) {
      return undefined;
