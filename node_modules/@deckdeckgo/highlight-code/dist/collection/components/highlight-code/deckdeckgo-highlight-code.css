...
div.carbon {
  ...
  padding: var(--deckgo-highlight-code-carbon-header-padding, 8px 16px);
...
div.carbon > div {
  ...
  margin: var(--deckgo-highlight-code-carbon-header-button-margin, 8px 6px 8px 0);
}
div.carbon > div.red {
...
div.ubuntu > div.close span, div.ubuntu > div.minimize span, div.ubuntu > div.maximize span {
